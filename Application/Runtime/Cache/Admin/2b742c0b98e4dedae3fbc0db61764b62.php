	...
	<div class="wrap-r">
        ...
        <div class="content">
        	<table>
                ...
                <tbody>
                	<tr class="tody">
                    	<td colspan="4"><div class="td-wrap"><em>今天 (</em><a href="javascript:;" class="msg-num">3</a>封)</div></td>
                    </tr>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                    	<td class="icon"><div class="td-wrap"></div></td>
                        <td class="sender"><div class="td-wrap"><?php echo ($vol["truename"]); ?></div></td>
                        <td class="subject"><div class="td-wrap"><a href="javascript:;"><?php echo ($vol["content"]); ?></a></div></td>
                        <td class="time"><div class="td-wrap"><?php echo (date("Y-m-d H:i",$vol["addtime"])); ?></div></td>

      ...
      <div class="login-info ue-clear">
        ...
        <!--
          target几种方式：
              ...
              _top:顶级窗口打开
              _parent:父窗口打开
              iframe的name值:表示在指定的iframe中打开页面
        -->
        <div class="login-msg ue-clear"> <a href="<?php echo U('Email/recBox');?>" target="main" class="msg-txt">消息</a> <a href="<?php echo U('Email/recBox');?>" target="main" class="msg-num">10</a> </div>
      </div>
      <div class="toolbar ue-clear"> <a href="<?php echo U('Index/index');?>" class="home-btn" target="mainframe">首页</a> <a href="javascript:;" class="quit-btn exit"></a> </div>
    </div>
  </div>
  <div id="bd">
    <div class="wrap ue-clear">
      ...
      <div class="content">
        <iframe src="/index.php/Admin/Index/home" name='main' id="iframe" width="100%" height="100%" frameborder="0"></iframe>
      </div>
    </div>
  </div>

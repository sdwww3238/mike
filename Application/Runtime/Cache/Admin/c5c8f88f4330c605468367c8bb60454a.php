...
<div class="main">
	<p class="short-input ue-clear">
        <input name="id"  placeholder="" value="<?php echo ($data["id"]); ?>" type="hidden"/>
    	<label>用户名：</label>
    ...
    <div class="short-input select ue-clear">
        ...
        <select>
            ...
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="$vol.id"><?php echo ($vol["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
	<p class="short-input ue-clear">
    	<label>性别：</label>
    ...
    <p class="short-input ue-clear">
    	<label>备注：</label>
        <textarea name="remark" style="font-family:Microsoft YaHei !important; font-size:14px;" placeholder="请输入内容"  ><?php echo ($data["remark"]); ?></textarea>
    </p>
</div>
